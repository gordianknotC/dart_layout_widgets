...
class ScrollerNestableSlidingUpPanel extends SlidingUpPanel{
	ScrollerNestableSlidingUpPanel({
		...
		key: key, panel: panel, body: body, collapsed: collapsed,
		minHeight: minHeight, maxHeight: maxHeight, border: border,
		borderRadius: borderRadius, boxShadow: boxShadow, color: color,
		padding: padding, margin: margin, renderPanelSheet: renderPanelSheet,
		panelSnapping: panelSnapping, backdropEnabled: backdropEnabled,
		backdropOpacity: backdropOpacity, backdropTapClosesPanel: backdropTapClosesPanel,
		onPanelSlide: onPanelSlide, parallaxEnabled: parallaxEnabled, parallaxOffset: parallaxOffset,
		isDraggable: isDraggable,		slideDirection: slideDirection, defaultPanelState: defaultPanelState,
		// ----------------------------
		onPanelClosed: gestureController.wrapOnClosed(onPanelClosed ?? (){}),
		onPanelOpened: gestureController.wrapOnOpened(onPanelOpened ?? (){}),
